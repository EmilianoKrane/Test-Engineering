// Demo Completa: HDMI + IMU (BMI270) + MicroSD + PSRAM + PDM Microphone
// Arduino Nano RP2350 - Cubo 3D con logging a SD, PSRAM y audio
// Control con acelerómetro/giroscopio y captura de audio
...
void setup() {
  ...
  Serial.println("\n========================================");
  Serial.println("Demo Completa RP2350");
  Serial.println("HDMI + BMI270 + MicroSD + PSRAM + PDM");
  Serial.println("========================================\n");

  // Mostrar RAM disponible al inicio
  Serial.print("RAM libre inicial: ");
  Serial.print(rp2040.getFreeHeap() / 1024);
  Serial.println(" KB\n");

  // ============ PASO 1: Inicializar HDMI ============
  ...
  // ============ PASO 2: Inicializar I2C para BMI270 ============
  Serial.print("2. Inicializando I2C (SDA=8, SCL=9)... ");
  Wire.setSDA(8);
  Wire.setSCL(9);
  Wire.begin();
  delay(100);
  ...
  Serial.print("3. Inicializando BMI270... ");
