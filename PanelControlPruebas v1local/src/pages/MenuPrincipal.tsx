...
const buttons = [
  { label: "Ecosistema UNIT", to: "/EcosistemaUNIT", image: "/img/UNIT.png", protected: false},
  { label: "Proyectos", to: "/Proyectos", image: "/img/UNIT.png", protected: false},
  

  { label: "TEST UE0089 Cargador de Baterías", to: "/CargadorBaterias", image: "/img/UE0089 CargadorBaterias.jpg", protected: true},
  { label: "TEST AR0150 Regulador de Voltaje", to: "/ReguladorVoltaje", image: "/img/AR0150LM2596.jpg", protected: true},
  { label: "TEST AR4353 Señuelo de Carga", to: "/SeñueloCarga", image: "/img/AR4353 SeñueloCarga.jpg", protected: false},
  ...
  { label: "Configuración de Carga Variable", to: "/CargaVariable", image: "/img/CargaVariable.png", protected: true},
    ...
    <div style={{ minHeight: "100vh", position: "relative" }}>
      ...
      >
        <h1 style={{ marginBottom: "30px", 
            textAlign: "center", 
            paddingRight: "0px",
            color: "#0c0c0cff"}}>Menú Principal de Pruebas</h1>
