...
async function runCortocircuitoTest(){
  try{
    ...
    console.log("➡️ Midiendo demanda break...");
...
async function runPolaridadTest(){
  try{
        ...
        await delay(1000);
        console.log("➡️ Enviando Polaridad...");
        console.log("➡️ Configurando la carga a 3A...");
        await sendToLoad('{"Funcion": "DYN", "Config": {"Resolution": [3, 1, 3, 1], "Range": [50, 30]}, "Start": "CFG_ON"}');
        await delay(1000);
        ...
        console.log("➡️ Enviando Inv Polaridad...");
        ...
        if (OKDemandaP2){
          ...
          await sendToLoad('{"Funcion": "Other", "Config": {"Resolution": [], "Range": []}, "Start": "CFG_OFF"}');
          //Enviar datos de funcionamiento a la Pulsar para DB
          sendToPulsar(JSON.stringify({ Function: "TestPolaridad", Estado: "OK" }) + "\n");          
        }
        else{
...
async function runCargaVariableTest() {
  try {
    ...
    console.log("➡️ Configurando la carga a 3.4A...");
    ...
    if (!OKCV2) {
      console.log("❌ Falló demanda nominal CV2");
      setLED3On("off");
      await sendToLoad('{"Funcion": "Other", "Config": {"Resolution": [], "Range": []}, "Start": "CFG_OFF"}');
      sendToPulsar(JSON.stringify({ Function: "TestCarga", Estado: "FALLA" }) + "\n");
      return;
    ...
    console.log("➡️ Configurando la carga a 4A...");
    ...
    if (!OKCV3) {
      console.log("❌ Falló demanda nominal CV3");
      setLED3On("off");
      await sendToLoad('{"Funcion": "Other", "Config": {"Resolution": [], "Range": []}, "Start": "CFG_OFF"}');
      sendToPulsar(JSON.stringify({ Function: "TestCarga", Estado: "FALLA" }) + "\n");
      return;
    ...
    console.log("✅ Demanda Nominal CV3 OK");
    setLED3On("on");
    await sendToLoad('{"Funcion": "Other", "Config": {"Resolution": [], "Range": []}, "Start": "CFG_OFF"}');
    sendToPulsar(JSON.stringify({ Function: "TestCarga", Estado: "OK" }) + "\n");
