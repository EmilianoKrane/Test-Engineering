...
class BMM150_I2C:
    ...
    def read_raw(self):
        try:
            ...
            resp = "OK"
            return (x, y, z, resp, "I2C", self.addr)
        except:
            print("⚠️ Error leyendo datos I2C")
            self.initialized = False
            resp = "Fail"
            return (0, 0, 0, resp, "I2C", self.addr)
...
class BMM150_SPI:
    ...
    def read_raw(self):
        try:
            ...
            z = struct.unpack("<h", data[4:6])[0] >> 1
            resp = "OK"
            return (x, y, z, resp, "SPI", "NA")

        except:
            print("⚠️ Error leyendo datos SPI")
            self.initialized = False
            resp = "Fail"
            return (0, 0, 0, resp, "SPI", "NA")
...
class BMM150_Auto:
    ...
    def read_raw(self):
        ...
        if self.driver:
            return self.driver.read_raw()

        return (0, 0, 0, "Fail", None, None)
